...
| `20260730-sm13` | Nested folder one-tap correction | Added one guarded expansion retry for a nested Library Browser folder that began collapsed and remained collapsed after SwingJS applied selection. Deep folders such as `01_measurement / trz` now open with one tap, while tapping an already expanded folder still collapses it normally. |
